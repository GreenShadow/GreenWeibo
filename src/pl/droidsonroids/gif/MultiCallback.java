...
/**
 * {@link Callback} which allows single {@link Drawable} to be associated with
 * multiple {@link View}s. If drawable needs to be redrawn all its views are
 * invalidated.
 *
 * @author koral--
 * @author Doctoror
...
public class MultiCallback implements Callback {
	...
	/**
	 * Associates given {@link View}. If view has been already added, nothing
	 * happens.
	 *
	 * @param view
	 *            View to be associated
	 */
	...
	/**
	 * Disassociates given {@link View}. If view is not associated, nothing
	 * happens.
	 *
	 * @param view
	 *            View to be disassociated
	 */
